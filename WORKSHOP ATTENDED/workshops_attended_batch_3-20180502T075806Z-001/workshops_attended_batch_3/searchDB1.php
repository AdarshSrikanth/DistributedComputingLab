...
//Select query
  ...
  $sql = "SELECT ename FROM programs_attended WHERE ename LIKE '%".$value."%';";
...
*/
      echo '<a href=displayid1.php?ename='.$matched[$count].'><li>'.$matched[$count].'</li></a>';
     }
     $count++;
    }
   echo '</ul>';
   }else{
    echo "<font color='red' style='font-size: 20px'><b><<< No such Name exists >>></b></font>";    
   }
  }
?>
