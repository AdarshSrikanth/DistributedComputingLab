...
<div class="container">
  <form method="post" action="display2.php">
    <div class="row">
        ...
        <h4>Staff with Year Of Publication</h4>
      <div class="input-group input-group-icon">
        <input type="text" list="search_text" placeholder="Enter the staff name(Double Click for Suggestions)" name="name" required/>

        <datalist name="search_text" id="search_text"/></datalist><br/><br/>
        <input type="number" placeholder="Enter the Year" value="null" name="year"/>
