<?php
	...
	$sql="SELECT * FROM programs_attended WHERE duration='$var'";
...
<div class="add">
<center><a href="search3.html"><button style="border-radius: 50px; width: 70px; height: 70px"><img src="images/back.png" style="width: 100%"/></a></button></center>
</div>
<div class="add1">
