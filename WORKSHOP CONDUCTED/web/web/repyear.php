...
$result = mysqli_query($conn, "SELECT eid,ename,natureofprogram,nameofworkshop,duration,fromdate,todate,venue FROM programs_attended WHERE YEAR(fromdate)='$year'") or die("database error:". mysqli_error($connString));
