...
$result = mysqli_query($conn, "SELECT eid,ename,natureofprogram,duration,noofparticipants,fromdate,todate,venue FROM programs_attended WHERE natureofprogram='$nop'") or die("database error:". mysqli_error($conn));
