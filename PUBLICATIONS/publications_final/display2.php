...
<body>
  ...
  <div class="form">
	<a href="staffwithyear.php"> <button type="button" name="submit" class="button" style="float:left;"><span>Go Back</span></button></a><br>
<?php
$name=$_POST["name"];
$tname=$_POST["year"];
if($tname==null)
{
		$sql="SELECT * FROM journal_details WHERE name='$name'";
	//echo $sql;

}
else
{
	$sql="SELECT * FROM journal_details WHERE year='$tname' and name='$name'";
	//echo "else";
}
//echo $tname;
