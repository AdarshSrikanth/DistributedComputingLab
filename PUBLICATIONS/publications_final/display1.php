...
<body>
  ...
  <div class="form">
  	<a href="year.php"> <button type="button" name="submit" class="button" style="float:left;"><span>Go Back</span></button></a><br>
...
{
	$tname1=$tname;
	$sql="SELECT * FROM journal_details WHERE year='$tname1'";
	//echo $sql;

}
else
{
	$sql="SELECT * FROM journal_details WHERE year BETWEEN '$tname' and '$tname1'";
	//echo "else";
}
