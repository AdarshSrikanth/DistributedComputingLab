...
<body>
<form method="post">
Faculty code:<input type="text" name="fc"/><br/><br/>
Year:<input type="month" name="year"/><br/><br/>
Semester:<input type="radio" name="sem" value="Odd"/>Odd
		 <input type="radio" name="sem" value="Even"/>Even<br/><br/>
Training area:<input type="text" name="training"/><br/><br/>
Upload the file:<input type="file" name="upload"/><br/><br/>
	...
	<div >
      ...
      <span id="Lblpas" style="color:White;font-size:Medium;font-weight:bold;">Program Title</span> &nbsp;&nbsp;&nbsp
            <input name="prog" type="text" id="TxtPasswd" class="txtmar" />
                <br />
				<br/>
		<span id="Lblpas" style="color:White;font-size:Medium;font-weight:bold;">Whether this program is relevant to training area?</span>&nbsp;&nbsp;&nbsp
		<input type="radio" value="odd" name="sem"/><span id="Lblpas" style="color:White;font-size:Medium;font-weight:bold;">Yes</span>
