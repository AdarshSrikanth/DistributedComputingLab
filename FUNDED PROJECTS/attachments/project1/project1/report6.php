...
// Column headings
    ...
    $sql="SELECT name,facultyname,title,amount,sfrom,sto,status from funded WHERE facultyname='$var_value' UNION  SELECT company,name,title,amount,fromd,tood,status from consult WHERE  name ='$var_value'";
   // WHERE eid='$var'";
