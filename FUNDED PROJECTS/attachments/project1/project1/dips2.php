...
<div class="container">
  <form method="post" action="report7.php" enctype="multipart/form-data">
     <h3>Company/Agency Name</h3>
		 <input type="text" list="search_text" name="varname" required placeholder="Company/Agency Name"><br>
