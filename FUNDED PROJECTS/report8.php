...
if($to!=""){
	$sql="SELECT name,facultyname,title,amount,sfrom,sto,status from funded WHERE sfrom >='$var_value' AND sto <='$to' UNION  SELECT company,name,title,amount,fromd,tood,status from consult WHERE  fromd >='$var_value' AND tood <= '$to'";
}
else{
	$sql="SELECT name,facultyname,title,amount,sfrom,sto,status from funded WHERE sfrom >='$var_value' UNION  SELECT company,name,title,amount,fromd,tood,status from consult WHERE  fromd >='$var_value'";
}
