...
<body>
	...
	<div class="container">
		<form action="store2.php" method="post" enctype="multipart/form-data">
			...
			<div class="input-group input-group-icon">
				...
				<div class="input-icon"><i class="fa fa-user"></i></div>
						<div id="main">
							<input type="button" id="btAdd" value="Add group members" class="bt" style="width:50%"/>
							<input type="button" id="btRemove" value="Remove group members" class="bt" style="width:50%"/>
						</div>
			</div>
    	...
    	<h3>Total Amount</h3>
			...
			<h3>Upload Pdf</h3>
			<center><input type="file" name="pdf"  accept=".pdf" /></center>
